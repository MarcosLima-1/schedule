...
function eventMatchesCombo(event: KeyboardEvent, normalizedCombo: string): boolean {
	const modifiers = ["ctrl", "alt", "shift", "meta"];
	const eventMods = [
...
export function useKeypress({ combo, callback, preventDefault = false, target }: UseKeyboardOptions) {
